...
function uploadData(blob,type){
	...
	$('#recordedAudioSpan').show();
		...
		$('#progressBar').html($(globalXmlvar).find('Uploading').text()+' '+$(globalXmlvar).find('UploadLoaderMessage').text());
		//$('#pWait').show();
...
//Listen to the upload progress
    ...
    $('#progressBar').html($(globalXmlvar).find('Uploading').text()+' '+percent+'%'+$(globalXmlvar).find('UploadLoaderMessage').text());
