...
//    alert(Math.max(0, pos.bottom - pos.top)+" and "+cm.options.cursorHeight+" and "+pos.bottom+" and "+pos.top+" and "+pos);
  ...
  CodeMirror.fromTextArea = function(textarea, options) {
    ...
    if (options.autofocus == null) {
      ...
      options.autofocus = true; // This needs to be done to have focus always on the text editor.
    }
